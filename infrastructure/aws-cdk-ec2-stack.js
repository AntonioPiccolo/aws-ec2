...
class AwsEc2Stack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const filesBucket = new s3.Bucket(this, 'AwsEc2FilesBucket', {
      bucketName: `aws-ec2-files-${this.account}`,
    ...
    const securityGroup = new ec2.SecurityGroup(this, 'AwsEc2SecurityGroup', {
      vpc: vpc,
    ...
    // IAM Role for EC2
    const ec2Role = new iam.Role(this, 'AwsEc2Role', {
    ...
    userData.addCommands(
      ...
      '    environment:',
      '      - NODE_ENV=production',
      '      - DATABASE_URL=postgresql://aws_user:aws_password@db:5432/aws_ec2',
      ...
      'chown -R ec2-user:ec2-user /home/ec2-user/aws-ec2',
    ...
    // EC2 Instance
    const instance = new ec2.Instance(this, 'AwsEc2Instance', {
      vpc: vpc,
      ...
      role: ec2Role,
      userData: userData,
      keyPair: ec2.KeyPair.fromKeyPairName(this, 'KeyPair', 'aws-ec2-key'),
    });

    // Elastic IP for static public IP
    const eip = new ec2.CfnEIP(this, 'AwsEc2EIP', {
    ...
    new cdk.CfnOutput(this, 'SSHCommand', {
      value: `ssh -i aws-ec2-key.pem ec2-user@${eip.ref}`,
      description: 'SSH command to connect to instance',
    });
  }
}

module.exports = { AwsEc2Stack };